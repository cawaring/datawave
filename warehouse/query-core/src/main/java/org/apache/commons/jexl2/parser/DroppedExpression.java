...
/**
 * Represents a node which captures an expression which will be dropped/ignored. The ignored express will be assigned to the _Query_ variable.
 */
public class DroppedExpression extends QueryPropertyMarker {
     ...
     * expression avoiding its evaluation.
     *
     * @param node
     *            the source node
     ...
     * this case the source node is turned into a string which is assigned to a variable such that this expression avoiding its evaluation.
     *
     * @param source
     *            the source node
     * @param reason
