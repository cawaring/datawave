...
public abstract class HitsAreAlwaysIncludedTest {
    ...
    public void testHitForIndexedQueryTerm() throws Exception {
        ...
        Set<String> goodResults = Sets.newHashSet(
                "FOO_1_BAR.FOO.3:good<cat>", "FOO_3_BAR.FOO.3:defg<cat>", "FOO_3.FOO.3.3:defg", "FOO_4.FOO.4.3:yes", "FOO_1.FOO.1.3:good",
                "FOO_1.FOO.1.0:yawn",
                "FOO_1_BAR.FOO.0:yawn<cat>", "FOO_1_BAR.FOO.1:yawn<cat>",
                "FOO_1_BAR_1.FOO.0:2021-03-24T16:00:00.000Z",
                "FOO_3.FOO.3.0:abcd",
                "FOO_3_BAR.FOO.0:abcd<cat>",
                "FOO_4.FOO.4.0:purr", "FOO_4.FOO.4.1:purr");
        //@formatter:on
    ...
    public void testHitForIndexedAndUnindexedQueryAndAnyfieldLimit() throws Exception {
        ...
        Set<String> goodResults = Sets.newHashSet("FOO_1_BAR.FOO.3:good<cat>", "FOO_3_BAR.FOO.3:defg<cat>", "FOO_3.FOO.3.3:defg", "FOO_4.FOO.4.3:yes",
                "FOO_1.FOO.1.0:yawn", "FOO_1.FOO.1.3:good",
                "FOO_1_BAR.FOO.0:yawn<cat>",
                "FOO_1_BAR_1.FOO.0:2021-03-24T16:00:00.000Z",
                "FOO_3.FOO.3.0:abcd",
                "FOO_3_BAR.FOO.0:abcd<cat>",
    ...
    public void testHitWithoutGroupingContext() throws Exception {
        ...
        Set<String> goodResults = Sets.newHashSet("FOO_3_BAR:defg<cat>",
                "FOO_1:yawn", "FOO_1:good",
                "FOO_1_BAR:yawn<cat>", "FOO_1_BAR:good<cat>",
                "FOO_1_BAR_1:2021-03-24T16:00:00.000Z",
                "FOO_3:abcd", "FOO_3:bcde",
                "FOO_3_BAR:abcd<cat>",
                "FOO_4:purr", "FOO_4:yes");
        //@formatter:on
    ...
    public void testHitWithRange() throws Exception {
        ...
        Set<String> goodResults = Sets.newHashSet("FOO_1_BAR_1:2021-03-24T16:00:00.000Z",
                ...
                "FOO_1_BAR:yawn<cat>", "FOO_1_BAR:good<cat>",
                "FOO_3:abcd", "FOO_3:bcde",
                "FOO_3_BAR:abcd<cat>", "FOO_3_BAR:bcde<cat>",
                "FOO_4:purr", "FOO_4:yes");
        //@formatter:on
