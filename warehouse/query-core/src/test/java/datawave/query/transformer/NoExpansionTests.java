...
public abstract class NoExpansionTests {
    ...
    private Connector createConnector() throws Exception {
        Connector connector = new QueryTestTableHelper(getClass().getName(), log, RebuildingScannerTestHelper.TEARDOWN.NEVER,
                        RebuildingScannerTestHelper.INTERRUPT.NEVER).connector;
        VisibilityWiseGuysIngestWithModel.writeItAll(connector, getRange());
